...
def RMI_adaptive_total(input_vi, input_ir, fused_result):
    vi_loss = RMI_vi(input_vi,fused_result)
    ir_loss = RMI_ir(input_ir,fused_result)
    ir_tensor_entropy = tensor_entropy(input_ir)
    vi_tensor_entropy = tensor_entropy(input_vi)
    ir_tensor_entropy = ir_tensor_entropy/(ir_tensor_entropy+vi_tensor_entropy)
    vi_tensor_entropy = vi_tensor_entropy/(ir_tensor_entropy+vi_tensor_entropy)
    
    adaptive_rmi_loss = (ir_tensor_entropy * vi_loss + vi_tensor_entropy * ir_loss)
    return adaptive_rmi_loss
